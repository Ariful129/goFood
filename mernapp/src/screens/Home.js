...
export default function Home() {
   ...
   const loadData= async ()=>{
     let response=await fetch("http://localhost:5009/api/foodData",{
      method:"POST",
      headers:{
         ...
         <div><Navbar /></div>
          <div><div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel" style={{objectFit:"contain !important"}}>
            <div className="carousel-inner" id='carousel'>
                ...
                <div className="carousel-item">
                    <img src="https://source.unsplash.com/random/300×300/?sea" className="d-block w-100" style={{filter:"brightness(30%)"}} alt="..." />
                </div>
            </div>
